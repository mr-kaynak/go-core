...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_mr-kaynak_go-core_internal_api_response.PaginatedResponse-internal_modules_identity_api_APIKeySafeResponse"
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.DashboardResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.SendTestEmailRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_mr-kaynak_go-core_internal_api_response.PaginatedResponse-internal_modules_identity_api_SessionSafeResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.SystemHealthResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.BulkAssignRoleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.BulkOperationResult"
                        }
                    },
                    "207": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_modules_identity_api.BulkUpdateStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_mr-kaynak_go-core_internal_api_response.PaginatedResponse-internal_modules_identity_api_APIKeySafeResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_modules_identity_api.APIKeySafeResponse"
                    }
                },
                "pagination": {
        ...
        "github_com_mr-kaynak_go-core_internal_api_response.PaginatedResponse-internal_modules_identity_api_SessionSafeResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_modules_identity_api.SessionSafeResponse"
                    }
                },
                "pagination": {
                    "$ref": "#/definitions/github_com_mr-kaynak_go-core_internal_api_response.Pagination"
        ...
        "internal_modules_identity_api.APIKeySafeResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_modules_identity_api.BulkAssignRoleRequest": {
            "type": "object",
            "properties": {
                "role_id": {
                    "type": "string"
        ...
        "internal_modules_identity_api.BulkOperationError": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "internal_modules_identity_api.BulkOperationResult": {
            "type": "object",
            "properties": {
                "failure_count": {
                    "type": "integer"
                ...
                "failures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_modules_identity_api.BulkOperationError"
                    }
                },
                "success_count": {
                    "type": "integer"
        ...
        "internal_modules_identity_api.BulkUpdateStatusRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
        ...
        "internal_modules_identity_api.ComponentHealth": {
            "type": "object",
            "properties": {
                "details": {},
                "error": {
        ...
        "internal_modules_identity_api.DashboardResponse": {
            "type": "object",
            "properties": {
                "notifications": {
                    "$ref": "#/definitions/internal_modules_identity_api.NotificationStats"
                },
                "sse": {},
                "system": {
                    "$ref": "#/definitions/internal_modules_identity_api.SystemInfo"
                },
                "users": {
                    "$ref": "#/definitions/internal_modules_identity_api.UserStats"
                }
            }
        },
        ...
        "internal_modules_identity_api.NotificationStats": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "internal_modules_identity_api.SendTestEmailRequest": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "internal_modules_identity_api.SessionSafeResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_modules_identity_api.SystemHealthResponse": {
            "type": "object",
            "properties": {
                "components": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/internal_modules_identity_api.ComponentHealth"
                    }
                },
                "overall_status": {
        ...
        "internal_modules_identity_api.SystemInfo": {
            "type": "object",
            "properties": {
                "uptime": {
                    "type": "string"
        ...
        "internal_modules_identity_api.UserStats": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "integer"
