...
//
// Deprecated: Use ProblemDetail instead. This type will be removed in a future version.
type Error struct {
...
// IsProblemDetail checks if an error is a ProblemDetail, including wrapped errors
func IsProblemDetail(err error) bool {
	var pd *ProblemDetail
	return errors.As(err, &pd)
}

// GetProblemDetail extracts ProblemDetail from an error, including wrapped errors
