...
func (r *stubUserRepo) GetByID(_ context.Context, _ uuid.UUID) (*domain.User, error) {
	return r.user, r.findErr
}
func (r *stubUserRepo) GetByIDForUpdate(_ context.Context, _ uuid.UUID) (*domain.User, error) {
	return r.user, r.findErr
}
...
func (r *stubUserRepo) GetAll(_ context.Context, _, _ int) ([]*domain.User, error) { return nil, nil }
func (r *stubUserRepo) GetByIDs(_ context.Context, _ []uuid.UUID) ([]*domain.User, error) {
	return nil, nil
}
func (r *stubUserRepo) ListFiltered(_ context.Context, _ domain.UserListFilter) ([]*domain.User, int64, error) {
	return nil, 0, nil
}
func (r *stubUserRepo) Count(_ context.Context) (int64, error) { return 0, nil }
func (r *stubUserRepo) ExistsByEmail(_ context.Context, _ string) (bool, error) {
	return false, nil
}
func (r *stubUserRepo) ExistsByUsername(_ context.Context, _ string) (bool, error) {
	return false, nil
}
func (r *stubUserRepo) LoadRoles(_ context.Context, _ *domain.User) error  { return nil }
func (r *stubUserRepo) Create(_ context.Context, _ *domain.User) error     { return nil }
func (r *stubUserRepo) Update(_ context.Context, _ *domain.User) error     { return r.updErr }
func (r *stubUserRepo) Delete(_ context.Context, _ uuid.UUID) error        { return nil }
func (r *stubUserRepo) CreateRole(_ context.Context, _ *domain.Role) error { return nil }
func (r *stubUserRepo) UpdateRole(_ context.Context, _ *domain.Role) error { return nil }
func (r *stubUserRepo) DeleteRole(_ context.Context, _ uuid.UUID) error    { return nil }
func (r *stubUserRepo) GetRoleByID(_ context.Context, _ uuid.UUID) (*domain.Role, error) {
	return nil, nil
}
func (r *stubUserRepo) GetRoleByName(_ context.Context, _ string) (*domain.Role, error) {
	return nil, nil
}
func (r *stubUserRepo) GetAllRoles(_ context.Context) ([]*domain.Role, error) { return nil, nil }
func (r *stubUserRepo) AssignRole(_ context.Context, _, _ uuid.UUID) error    { return nil }
func (r *stubUserRepo) RemoveRole(_ context.Context, _, _ uuid.UUID) error    { return nil }
func (r *stubUserRepo) GetUserRoles(_ context.Context, _ uuid.UUID) ([]*domain.Role, error) {
	return nil, nil
}
func (r *stubUserRepo) CreatePermission(_ context.Context, _ *domain.Permission) error { return nil }
func (r *stubUserRepo) UpdatePermission(_ context.Context, _ *domain.Permission) error { return nil }
func (r *stubUserRepo) DeletePermission(_ context.Context, _ uuid.UUID) error          { return nil }
func (r *stubUserRepo) GetPermissionByID(_ context.Context, _ uuid.UUID) (*domain.Permission, error) {
	return nil, nil
}
func (r *stubUserRepo) GetAllPermissions(_ context.Context) ([]*domain.Permission, error) {
	return nil, nil
}
func (r *stubUserRepo) AssignPermissionToRole(_ context.Context, _, _ uuid.UUID) error { return nil }
func (r *stubUserRepo) RemovePermissionFromRole(_ context.Context, _, _ uuid.UUID) error {
	return nil
}
func (r *stubUserRepo) GetRolePermissions(_ context.Context, _ uuid.UUID) ([]*domain.Permission, error) {
	return nil, nil
}
func (r *stubUserRepo) CreateRefreshToken(_ context.Context, _ *domain.RefreshToken) error {
	return nil
}
func (r *stubUserRepo) GetRefreshToken(_ context.Context, _ string) (*domain.RefreshToken, error) {
	return nil, nil
}
func (r *stubUserRepo) RevokeRefreshToken(_ context.Context, _ string) error { return nil }
func (r *stubUserRepo) RevokeAllUserRefreshTokens(_ context.Context, _ uuid.UUID) error {
	return nil
}
func (r *stubUserRepo) GetActiveRefreshTokensByUser(_ context.Context, _ uuid.UUID) ([]*domain.RefreshToken, error) {
	return nil, nil
}
func (r *stubUserRepo) RevokeRefreshTokenByID(_ context.Context, _ uuid.UUID) error { return nil }
func (r *stubUserRepo) CleanExpiredRefreshTokens(_ context.Context) error           { return nil }
func (r *stubUserRepo) CountByStatus(_ context.Context, _ string) (int64, error)    { return 0, nil }
func (r *stubUserRepo) CountCreatedAfter(_ context.Context, _ time.Time) (int64, error) {
	return 0, nil
}
func (r *stubUserRepo) GetAllActiveSessions(_ context.Context, _, _ int, _ *uuid.UUID) ([]*domain.RefreshToken, error) {
	return nil, nil
}
func (r *stubUserRepo) CountActiveSessions(_ context.Context, _ *uuid.UUID) (int64, error) {
	return 0, nil
}
