...
func TestPostService(t *testing.T) {
	...
	t.Run("CreateDraft", func(t *testing.T) {
		testPostServiceCreateDraft(t, svc, ctx, authorID)
	})

	t.Run("Create and Update Post", func(t *testing.T) {
		testPostServiceCreateAndUpdatePost(t, svc, ctx, authorID)
	})

	t.Run("Transitions (Publish and Archive)", func(t *testing.T) {
		testPostServiceTransitionsPublishAndArchive(t, svc, ctx, authorID)
	})

	t.Run("Delete", func(t *testing.T) {
		testPostServiceDelete(t, svc, ctx, authorID)
	})

	t.Run("Read Operations", func(t *testing.T) {
		testPostServiceReadOperations(t, svc, ctx, authorID)
	})
}

func testPostServiceCreateDraft(t *testing.T, svc *PostService, ctx context.Context, authorID uuid.UUID) {
	t.Helper()
...
func testPostServiceCreateAndUpdatePost(t *testing.T, svc *PostService, ctx context.Context, authorID uuid.UUID) {
	t.Helper()
...
func testPostServiceTransitionsPublishAndArchive(t *testing.T, svc *PostService, ctx context.Context, authorID uuid.UUID) {
	t.Helper()
...
func testPostServiceDelete(t *testing.T, svc *PostService, ctx context.Context, authorID uuid.UUID) {
	t.Helper()
	req := &CreatePostRequest{
		Title:       "To Delete",
...
func testPostServiceReadOperations(t *testing.T, svc *PostService, ctx context.Context, authorID uuid.UUID) {
	t.Helper()
	req := &CreatePostRequest{
	...
	post, _ := svc.Create(ctx, req, authorID)
	if _, err := svc.Publish(ctx, post.ID, authorID, false); err != nil {
